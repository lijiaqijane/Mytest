...
graph = Graph("http://10.1.31.208:7474", username="neo4j", password='123456')
# graph.delete_all()
...
gn = open('output/node2id_baike.txt', 'a+', encoding='UTF-8') 
gr = open('output/relation2id_baike.txt', 'a+', encoding='UTF-8') 
...
line_num = 0
with open('baike_triples.txt','r',encoding='UTF-8') as source_file:
